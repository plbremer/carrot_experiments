...
def aquire_normalized_log_intensities_for_species_organ_compound_wrapper(temp_panda):
    ...
    for index,series in temp_panda.iterrows():
        ...
        temp_file_address='./soc_data/'+series['species']+'¬'+series['organ']+'¬'+str(series['target_id'])+'.bin'
...
if __name__=="__main__":
    ...
    all_species_organs_compounds_panda.to_pickle('./so_count_data/all_species_organs_compounds_panda.bin')
    ...
    species_organ_sample_count_and_average_fame_panda.to_pickle('./so_count_data/species_organ_sample_count_and_average_fame.bin')
